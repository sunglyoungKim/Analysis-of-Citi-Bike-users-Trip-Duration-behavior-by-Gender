...
\section{\section{\subsection{where $F_{Wd}$ is Frequency of Women trip duration, $F_{Md}$ is Frequency of Men trip duration, ${W_{n}}$ is total number of Women, and ${M_{m}}$ is total number of Men}}}
...
\subsection{I will use a significance level  $\alpha=0.05$}
